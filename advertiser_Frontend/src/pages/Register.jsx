...
export default function Register() {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true)
    try {
      await register({ ...form, telNumber: parseInt(form.phone) || 0 })
      navigate('/dashboard')
    } catch (err) {
    ...
    <div className="min-h-screen flex items-center justify-center p-4 relative z-10">
      <div className="w-full max-w-sm animate-fade-up">
        <div className="text-center mb-8">
          ...
          <p className="text-sm mt-1" style={{ color: 'var(--color-text-secondary)' }}>Get started with your free account</p>
        </div>
        ...
        <div className="card p-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label htmlFor="reg-name" className="block text-sm font-medium mb-1.5" style={{ color: 'var(--color-text-secondary)' }}>Full Name</label>
            ...
            <div>
              <label htmlFor="reg-email" className="block text-sm font-medium mb-1.5" style={{ color: 'var(--color-text-secondary)' }}>Email</label>
            ...
            <div>
              <label htmlFor="reg-phone" className="block text-sm font-medium mb-1.5" style={{ color: 'var(--color-text-secondary)' }}>Phone</label>
            ...
            <div>
              <label htmlFor="reg-password" className="block text-sm font-medium mb-1.5" style={{ color: 'var(--color-text-secondary)' }}>Password</label>
          ...
          <p className="text-sm text-center" style={{ color: 'var(--color-text-muted)' }}>
            ...
            <Link to="/login" style={{ color: 'var(--color-accent)' }} className="font-medium hover:underline">
              Sign in
            </Link>
          </p>
        </div>
